...
public class aniamteWP2RPMDown : StateMachineBehaviour
{
    ...
    {
        // Set targeted Object
        targetedObject = GameObject.Find("WP2RPMDown");        // Find GazeGuiding Components
        ...
        string color = "#FF4306"; // 
        gazeText.text = "Abweichung: WP2 RPM zu hoch\nAktion: WP2 RPM herunterfahren";

...
public class IncreaseWP2RPM : StateMachineBehaviour
{
    ...
    {
        // Set targeted Object
        targetedObject = GameObject.Find("WP2RPMUp");        // Find GazeGuiding Components
        ...
        string color = "#FF4306"; // 
        gazeText.text = "Abweichung: WP2RPM zu niedrig\nAktion: WP2RPM erhöhen";
